...
void til::frame_size_calculator::do_null_ptr_node(til::null_ptr_node * const node, int lvl) {
  // EMPTY
}

//---------------------------------------------------------------------------

void til::frame_size_calculator::do_ptr_index_node(til::ptr_index_node * const node, int lvl) {
  // EMPTY
}
