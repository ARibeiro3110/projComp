...
func_def : '(' tFUNCTION '(' type func_decls ')' decls_instrs ')' { $$ = new til::function_node(LINE, $5,                           $4, $7); }
         | '(' tFUNCTION '(' type            ')' decls_instrs ')' { $$ = new til::function_node(LINE, new cdk::sequence_node(LINE), $4, $6); }
         ;
